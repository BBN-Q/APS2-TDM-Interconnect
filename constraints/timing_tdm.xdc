...
set_false_path -from [get_pins tdm_sata_gen[*].SATA_interconnect_inst/rx_fifo/mem_reg*/*/CLK] -to [get_pins tdm_sata_gen[*].SATA_interconnect_inst/rx_fifo/mem_read_data_reg_reg[*]/D]
set_false_path -from [get_pins tdm_sata_gen[*].SATA_interconnect_inst/tx_fifo/mem_reg*/*/CLK] -to [get_pins tdm_sata_gen[*].SATA_interconnect_inst/tx_fifo/mem_read_data_reg_reg[*]/D]
